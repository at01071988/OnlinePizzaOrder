    ...
    return(
      ...
      <Menu secondary id='navbar'>
        ...
        <Container textAlign='center' id='confirmation-container'>
          ...
          <p id='confirmation-text'>Your order, <strong>#2222</strong> is now being prepared and will be delivered to: </p>
          <p><strong>{address}</strong></p>
          <p>within the next hour <span role='img' aria-label='motorcycle'>🛵</span> </p>
          <Image centered id='confirmation-img'  src='https://media.giphy.com/media/cmCHuk53AiTmOwBXlw/giphy.gif' />
