...
class App extends Component {
  ...
  componentDidMount(){
    ...
    const localStoragePaymentDetail = localStorage.getItem('paymentDetails');
    if(localStorageOrder) {
      this.setState({
        ...
        cardDetail: JSON.parse(localStoragePaymentDetail)
      });
    }
  }
  ...
  componentDidUpdate(){
    ...
    localStorage.setItem('paymentDetails', JSON.stringify(this.state.cardDetail));
  }
  ...
  updatePaymentDetails = (updatedPaymentDetails) => {
      let cardDetails = {...this.state.cardDetail};
      cardDetails = updatedPaymentDetails;
      this.setState({
            ...
            <Route exact path='/checkout' render={ (props) =>
              //<StripeProvider apiKey='pk_test_12345'>
                <Checkout {...props}
                  ...
                  paymentDetails={this.state.cardDetail}
